...
```{r, results='asis',message=FALSE, warning=FALSE, echo=FALSE}
knitr::kable(head(ppp1), caption = "Health Expenditure vs. WHO Region\n For Year 2000")
```
...
```{r, results='asis',message=FALSE, warning=FALSE, echo=FALSE}
knitr::kable(head(income), caption = "World Bank Income Group by World Health Organization Region ")
```

```{r, results='asis',message=FALSE, warning=FALSE, echo=FALSE}
knitr::kable(head(ppp2), caption = "Average Health Expenditure per capita by Region")
```
